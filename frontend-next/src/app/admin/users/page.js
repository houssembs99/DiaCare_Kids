                        ...
                        >
                            ...
                            <div className="flex gap-4">
                                ...
                                <button
                                    ...
                                    className="flex-1 py-4 bg-error border border-error/20 text-white rounded-2xl font-black uppercase tracking-widest hover:bg-error/0.80 transition-colors"
                                >
                                    Supprimer
                                </button>
                            </div>
