...
export default function HistoryPage() {
    ...
    const chartData = {
        ...
        datasets: [{
            label: 'Glycémie',
            data: [110, 145, 185, 130, 95, 120, 140],
            borderColor: '#088395',
        ...
        <DashboardLayout role="Parent">
            <div className="space-y-10 pb-32 text-white max-w-lg mx-auto">
                ...
                <div className="flex justify-between items-center pt-4">
                    ...
                    <button className="p-4 bg-white/5 border border-white/10 rounded-2xl text-white/40">
                        <Calendar size={20} />
                    </button>
                </div>
                ...
                <div className="bg-white/5 backdrop-blur-3xl border border-white/10 rounded-[40px] p-8 shadow-2xl overflow-hidden relative">
                    <div className="flex justify-between items-start mb-10">
                        <SectionHeader title="Évolution Hebdo" sub="Graphique des tendances" />
                        <div className="flex flex-col items-end">
                            <span className="text-3xl font-black italic">142</span>
                ...
                <div className="space-y-6">
                    <div className="flex justify-between items-center pl-4">
                        <h3 className="text-sm font-black uppercase tracking-[0.3em] text-white/30">Journal du jour</h3>
                                ...
                                <div className="flex items-center gap-6">
                                    <div className="flex flex-col items-center">
                                        ...
                                        <div className={cn(
                                            ...
                                            item.status === 'hypo' ? "bg-accent" : item.status === 'hyper' ? "bg-orange-500" : "bg-success"
                                        )} />
                                    </div>
                ...
                {/* Export Button */}
                <button className="w-full py-5 bg-[#088395]/10 border border-[#088395]/20 text-[#088395] rounded-3xl font-black uppercase tracking-widest text-[10px] hover:bg-[#088395] hover:text-white transition-all">
