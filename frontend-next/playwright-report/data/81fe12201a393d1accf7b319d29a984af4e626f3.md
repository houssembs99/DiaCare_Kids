...
- Name: dashboard.spec.js >> Dashboard Navigation >> should login as Parent and see dashboard
- Location: tests\dashboard.spec.js:4:3
...
Expected pattern: /.*parent\/dashboard/
...
- main:
  ...
  - button "Connexion"
  - button "Inscription"
  - textbox "Adresse Email": ahmed@gmail.com
  - textbox "Mot de Passe": ahmed2020
  - button
  - button "Se connecter"
- contentinfo:
  - link "DiaCareKids":
